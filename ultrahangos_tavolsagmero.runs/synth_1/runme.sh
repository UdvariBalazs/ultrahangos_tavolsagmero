...
HD_PWD='C:/I_felev/UKDA/ultrahangos_tavolsagmero/ultrahangos_tavolsagmero.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jelgenerator.vds -m64 -mode batch -messageDb vivado.pb -notrace -source jelgenerator.tcl
